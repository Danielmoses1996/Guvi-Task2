...
data_file = pd.read_csv('path_to_cloned_repository/data.csv')
...
# Insert the Pandas DataFrame into a MySQL table (assuming the table is named "phonepe_pulse_data")
data.to_sql("phonepypulse", connection, if_exists="replace", index=False)
